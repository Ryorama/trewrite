package kmerrill285.trewrite.world.biome.features.corruption;
...
public class CorruptionSpireFeature extends Feature<NoFeatureConfig> {
	
		
	
	   public CorruptionSpireFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
		 		...
		 		for (int y = 0; y < 64; y++) {
		 			for (int z = 0; z < 64; z++) {
			 			if (stuff[x][y][z] == Color.BLACK) {
			 				...
			 				worldIn.setBlockState(pos2, BlocksT.EBONSTONE.getDefaultState(), 2);
			 			}
