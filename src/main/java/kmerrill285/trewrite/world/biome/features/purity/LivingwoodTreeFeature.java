...
public class LivingwoodTreeFeature extends Feature<NoFeatureConfig> {
	
	
	   public LivingwoodTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
