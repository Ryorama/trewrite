...
public class JackalberryTreeFeature extends Feature<NoFeatureConfig> {
	
		
	
	   public JackalberryTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	   ...
	   public void tree(BlockPos pos, IWorld worldIn, Random r) {
		   ...
		   private class LSystem {
			   ...
			   public LSystem(LSystemPos pos, int maxIterations, boolean leaves, String...system) {
				   this.system.add(new L(pos, this, system, maxIterations, true));
				   this.leaves = leaves;
			   }
		   ...
		   private class L {
			   ...
			   public L(LSystemPos pos, LSystem parent, String[] system, int iterations, boolean main, LSystemVec...vecs) {
				   this.pos = pos;
			   ...
			   public void splitFront(Random rand) {
				   L l = new L(new LSystemPos(pos.getX() + 0,pos.getY() + 0, pos.getZ() + 0), parent, system, iterations + 1,false, cloneVecArray(FACES));
				   l.rot(-1);
				   l.place(rand);
				   l.size = size * 0.5f;
				   l.xy = true;
