...
public class TerrariaOreFeature extends Feature<TerrariaOreFeatureConfig> {
	public TerrariaOreFeature(Function<Dynamic<?>, ? extends TerrariaOreFeatureConfig> configFactoryIn) {
		      super(configFactoryIn);
		   }

		   public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, TerrariaOreFeatureConfig config) {
		   ...
		   protected boolean func_207803_a(IWorld worldIn, Random random, TerrariaOreFeatureConfig config, double p_207803_4_, double p_207803_6_, double p_207803_8_, double p_207803_10_, double p_207803_12_, double p_207803_14_, int p_207803_16_, int p_207803_17_, int p_207803_18_, int p_207803_19_, int p_207803_20_) {
		      int i = 0;
		                        ...
		                        for(int j2 = l; j2 <= k1; ++j2) {
		                           ...
		                           if (d8 * d8 + d9 * d9 + d10 * d10 < 1.0D) {
		                              ...
		                              if (!bitset.get(k2)) {
		                                 ...
		                                 if (config.target == worldIn.getBlockState(blockpos$mutableblockpos)) {
