...
//		return ItemsT.items.get(name);
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		event.getRegistry().registerAll(
				...
				COBALT_ORE = (ItemBlockT) new ItemBlockT(BlocksT.COBALT_ORE, "cobalt_ore").setMaxStack(999),
				PALLIDUM_ORE = (ItemBlockT) new ItemBlockT(BlocksT.PALLIDUM_ORE, "pallidum_ore").setMaxStack(999),
				MITHRIL_ORE = (ItemBlockT) new ItemBlockT(BlocksT.MITHRIL_ORE, "mitril_ore").setMaxStack(999),
				ORICHALCUM_ORE = (ItemBlockT) new ItemBlockT(BlocksT.ORICHALCUM_ORE, "orichalcum_ore").setMaxStack(999),
				ADAMANTITE_ORE = (ItemBlockT) new ItemBlockT(BlocksT.ADAMANTITE_ORE, "adamantite_ore").setMaxStack(999),
				TITANIUM_ORE = (ItemBlockT) new ItemBlockT(BlocksT.TITANIUM_ORE, "titanium_ore").setMaxStack(999),
				COBALT_BAR = new MetalBar(300, "cobalt_bar"),
				PALLIDUM_BAR = new MetalBar(300, "pallidum_bar"),
