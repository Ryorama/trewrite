...
import kmerrill285.trewrite.items.terraria.broadswords.MithrilSword;
...
public class ItemsT {
	...
	public static ItemBlockT PALLIDUM_ORE;
	public static ItemBlockT MITHRIL_ORE;
	...
	public static ItemT MITHRIL_BAR;
	public static ItemT ORICHALCUM_BAR;
	public static ItemT ADAMANTITE_BAR;
	public static ItemT TITANIUM_BAR;
	
	public static PWNHammer PWNHAMMER;
	
	public static ItemT LORE_CREEPER_ITEM;
	
	public static CobaltSword COBALT_SWORD;
	public static PallidumSword PALLIDUM_SWORD;
	public static MithrilSword MITHRIL_SWORD;
	public static OrichalcumSword ORICHALCUM_SWORD;
	public static AdamantiteSword ADAMANTITE_SWORD;
...
//		return ItemsT.items.get(name);
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		event.getRegistry().registerAll(
				...
				PALLIDUM_ORE = (ItemBlockT) new ItemBlockT(BlocksT.PALLIDUM_ORE, "pallidum_ore"),
				MITHRIL_ORE = (ItemBlockT) new ItemBlockT(BlocksT.MITHRIL_ORE, "mithril_ore"),
				...
				PALLIDUM_BAR = new MetalBar(1200, "pallidum_bar"),
				MITHRIL_BAR = new MetalBar(1200, "mithril_bar"),
				...
				LORE_CREEPER_ITEM = new BasicItem(new Properties().group(ItemGroup.MATERIALS), 1, "lore_creeper_item", true),
				COBALT_SWORD = new CobaltSword(),
				PALLIDUM_SWORD = new PallidumSword(),
				ORICHALCUM_SWORD = new OrichalcumSword(),
				MITHRIL_SWORD = new MithrilSword(),
				ADAMANTITE_SWORD = new AdamantiteSword(),
